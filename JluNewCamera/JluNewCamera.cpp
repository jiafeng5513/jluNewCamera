...
BEGIN_MESSAGE_MAP(CJluNewCameraApp, CWinApp)
...
CJluNewCameraApp::CJluNewCameraApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CJluNewCameraApp 对象

CJluNewCameraApp theApp;


// CJluNewCameraApp 初始化

BOOL CJluNewCameraApp::InitInstance()
{
